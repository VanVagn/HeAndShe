...
// HeAndShe.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CHeAndSheApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CHeAndSheApp::OnAppAbout)
...
// Создание CHeAndSheApp

CHeAndSheApp::CHeAndSheApp() noexcept
{
	...
	SetAppID(_T("HeAndShe.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CHeAndSheApp

CHeAndSheApp theApp;


// Инициализация CHeAndSheApp

BOOL CHeAndSheApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CHeAndSheDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CHeAndSheView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CHeAndSheApp
